        ...
        <RadioGroupOption as="template" v-for="method in methods" :key="method.id" :value="method.title"
          ...
          <div
            ...
            <div class="flex justify-center pb-4">
              <img v-if="method.img" :src="getImageUrl(method.img)" class="h-[140px] object-cover" alt />
            </div>
          </div>
        </RadioGroupOption>
      </div>
    ...
    <div class="px-32 mt-8">
      <form @submit.prevent="submitData">
        ...
        <CheckoutBottom class="lg:px-0">
          <div class="shrink-0">
            <button :disabled="isEmpty" :class="{ inactive: isEmpty }" type="submit" @click="nextStep"
