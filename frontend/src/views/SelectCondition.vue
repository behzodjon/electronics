<template>
  <div>
    <div v-if="items" class="animate__animated animate__lightSpeedInRight">
      <RadioGroup v-model="selected">
        ...
        <div class="-space-y-px bg-white rounded-none">
          ...
          <RadioGroupOption as="template" v-for="(item, index) in items" :key="index" @click="getConditionId(item)"
            :value="item.title" v-slot="{ checked, active }">
            <div :class="[
...
onMounted(async () => {
  ...
  items.value = conditionsData.data
})
