<template>
  <div class="relative bg-[#13FFA8]">
    <div class="max-w-7xl mx-auto py-2 px-3 sm:px-6 lg:px-8">
      <div class="pr-16 sm:text-center sm:px-16">
        <p class="font-baseline text-black">
          <span class="md:hidden"> Always 5% extra for students 🤙 </span>
          <span class="hidden md:inline"> Big news! We're excited to announce a brand new product. </span>
          <span class="block sm:ml-2 sm:inline-block">
            <a href="#" class="text-black font-bold underline"> Learn more <span aria-hidden="true">&rarr;</span></a>
          </span>
        </p>
      </div>
