<template>
  <footer class="bg-[#F9F9F9] border-t-2 border-[#EAEAEB]" aria-labelledby="footer-heading">
      ...
      <div class="xl:grid xl:grid-cols-3 xl:gap-8">
        <div class="grid grid-cols-2 gap-8 xl:col-span-2">
          <div class="md:grid md:grid-cols-2 md:gap-8">
            <div>
              <h3 class="text-sm font-semibold text-[#0C0D0D] tracking-wider uppercase">Solutions</h3>
              <ul role="list" class="mt-4 space-y-4">
                <li v-for="item in navigation.solutions" :key="item.name">
                  <a :href="item.href" class="text-base text-[#414244]  hover:text-white">
                    {{ item.name }}
                  </a>
                </li>
              </ul>
            ...
            <div class="mt-12 md:mt-0">
              <h3 class="text-sm font-semibold text-[#0C0D0D] tracking-wider uppercase">Support</h3>
              <ul role="list" class="mt-4 space-y-4">
          ...
          <div class="md:grid md:grid-cols-2 md:gap-8">
            <div>
              <h3 class="text-sm font-semibold text-[#0C0D0D] tracking-wider uppercase">Company</h3>
              <ul role="list" class="mt-4 space-y-4">
            ...
            <div class="mt-12 md:mt-0">
              <h3 class="text-XS font-semibold text-[#0C0D0D] tracking-wider uppercase">Legal</h3>
              <ul role="list" class="mt-4 space-y-4">
                <li v-for="item in navigation.legal" :key="item.name">
                  <a :href="item.href" class="text-sm text-[#414244] hover:text-white">
                    {{ item.name }}
                  </a>
                </li>
              </ul>
        ...
        <div class="mt-8 xl:mt-0">
          <h3 class="text-sm font-semibold text-[#0C0D0D] tracking-wider uppercase">Subscribe to our newsletter</h3>
          <p class="mt-4 text-base text-[#414244] ">The latest news, articles, and resources, sent to your inbox weekly.</p>
