...
<template>
  <div class="bg-none">
    <div class="max-w-2xl mx-auto px-4 py-24 sm:px-6 sm:py-10 lg:max-w-7xl lg:px-8">
      <!-- Details section -->
